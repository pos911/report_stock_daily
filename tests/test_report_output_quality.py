...
class ReportOutputQualityTests(unittest.TestCase):
    def setUp(self):
        self.bundle = {
            ...
            "macro": {
                ...
                "us3y": 3.8,
                "us3y_change_bp": 0.0,
                "us10y_us3y_spread": 0.2,
                "us10y_us3y_spread_change_bp": 0.0,
                "kr10y": 3.1,
                "kr10y_change_bp": 0.0,
                "brent": 80,
            ...
            "sector_etfs": [{"symbol": "396500", "name": "TIGER 반도체TOP10", "sector_group": "반도체", "theme_group": "반도체", "role": "primary", "exclude_from_signal": False, "data_status": "FRESH", "change_rate_1d": 0.03, "return_20d": 0.1, "trading_value_ratio_20d": 1.4, "foreign_net_buy": 1, "institutional_net_buy": -1, "warnings": []}],
            "watchlist": [{"name": "삼성전자", "symbol": "005930", "close_price": 268500, "change_rate_1d": 1.2, "signal_label": "강한 모멘텀 후보", "signal_score": 81, "sector_group": "반도체", "return_5d": 0.02, "return_20d": 0.03, "return_60d": 0.04, "trading_value_ratio_20d": 1.6, "foreign_net_buy": 1, "institutional_net_buy": 1, "roe": 10, "debt_ratio": 20, "short_ratio": 1, "data_status": "FRESH"}],
    ...
    def test_allowed_labels_are_present(self):
        regular = _build_simple_non_morning_report("regular", "2026-05-08", self.bundle)
        self.assertIn("강한 모멘텀 후보", regular)
    ...
    def test_closing_has_recap_line(self):
        closing = _build_simple_non_morning_report("closing", "2026-05-08", self.bundle)
        self.assertIn("KIS 거래량 상위", closing)
