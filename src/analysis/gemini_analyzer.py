...
"""
    ...
    def generate_morning_us_summary(self, market_data: dict, news_context: str) -> str:
        prompt = f"""
[미국 시장 수치]
...
"""
    ...
    def summarize_news_reason(self, stock_name: str, news_items: list[dict]) -> str:
        if not news_items:
            return ""
        compact_news = [
            {
...
"""
    ...
    def generate_top_volume_reason(self, context: dict) -> str:
        prompt = f"""
[종목/상품 컨텍스트]
